...
given an octal string => decimal output (as integer)

Treat invalid input as octal 0

About Octal (Base-8)
233 can be understood as series of powers of 8
...
valid octals can have leading zeros
valid octals must only contain [0-7] characters

class Octal constructor accepts string
Octal#to_decimal returns integer in base 10
...
Algorithm:
+ treat invalid input as octal 0
+ valid octal string match /[0-7]/

to_decimal
reverse string (edge '011' => '110')
parse string multiply digit by 8^index and sum
return integer sum
=end
