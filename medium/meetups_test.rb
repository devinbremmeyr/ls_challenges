...
+ The last Thurstday of January 2021

construct objects that represent a meetup date
+ month number (1-12)
+ a year (e.g. 2020)

determine the exact date in a month and year
+ 2nd wednesday of May 2021 => 12th of May, 2021

descriptors may be given as strings (case insensitive)
'first',
'second',
'third',
'fourth',
...
It's guaranteed that each day of the week, will have one a 'teenth'.

Some months do not have a 'fifth' of a certain weekday
...
Examples test cases:
given: first monday of May 2020
# => determine the exact date

class Meetup
  construcutor(year, month)
...
use the 'date' or 'DateTime' class in ruby
input as strings

use a hash to associate weekday names
schedule discriptors with integers or ranges
...
iterate over days until the first day
count the type of weekdays until descriptor is matched (1st-5th)

for teenth start from month day 13
month day (13..19) for teenth
