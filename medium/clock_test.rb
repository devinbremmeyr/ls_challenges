...
create a clock class, independent of date
be able to add minutes
subtract minutes

two clock objects represent the same time should be equal

Examples:

Data:

store minutes as an integer
output to_s as string

Algorithm:
the two tricky parts are:

formating the to_s string

doing addition correctly using % to wrap around midnight

simply doing
total_minutes % MINUTES_PER_DAY
should result in the correct time
=end
